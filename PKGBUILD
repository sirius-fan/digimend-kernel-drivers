# ref. https://aur.archlinux.org/cgit/aur.git/tree/PKGBUILD?h=digimend-kernel-drivers-dkms-git

_pkgbase=digimend-kernel-drivers
pkgname=digimend-kernel-drivers-dkms-private
pkgver=11.r0.gfcb2306
pkgrel=2
...
package() {
  ...
  rm "$pkgdir"/usr/src/"$_pkgbase"-"$pkgver"/PKGBUILD
}
